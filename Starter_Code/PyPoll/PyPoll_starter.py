...
winning_count = 0  # Number of votes the winning candidate received
winning_percentage = 0  # Percentage of votes the winning candidate
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if row[2] not in candidates:
            ...
            candidate_votes[row[2]] = 0 # Initialize the candidate's vote count to zero
